...
static const _TravelerMode_type_support_symbol_names_t _TravelerMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, traveler_msgs, msg, TravelerMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, traveler_msgs, msg, TravelerMode)),
  }
};
...
{
  return &::traveler_msgs::msg::rosidl_typesupport_cpp::TravelerMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, traveler_msgs, msg, TravelerMode)() {
  return get_message_type_support_handle<traveler_msgs::msg::TravelerMode>();
}
