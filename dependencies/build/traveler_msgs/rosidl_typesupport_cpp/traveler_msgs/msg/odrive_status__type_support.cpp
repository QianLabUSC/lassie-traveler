...
static const _OdriveStatus_type_support_symbol_names_t _OdriveStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, traveler_msgs, msg, OdriveStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, traveler_msgs, msg, OdriveStatus)),
  }
};
...
{
  return &::traveler_msgs::msg::rosidl_typesupport_cpp::OdriveStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, traveler_msgs, msg, OdriveStatus)() {
  return get_message_type_support_handle<traveler_msgs::msg::OdriveStatus>();
}
