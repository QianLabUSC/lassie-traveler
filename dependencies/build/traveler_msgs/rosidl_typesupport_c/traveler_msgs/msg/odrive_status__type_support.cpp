...
#include "traveler_msgs/msg/detail/odrive_status__type_support.h"
...
static const _OdriveStatus_type_support_symbol_names_t _OdriveStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, traveler_msgs, msg, OdriveStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, traveler_msgs, msg, OdriveStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, traveler_msgs, msg, OdriveStatus)() {
  return &::traveler_msgs::msg::rosidl_typesupport_c::OdriveStatus_message_type_support_handle;
}
