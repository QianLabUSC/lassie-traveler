...
bool cdr_serialize_traveler_msgs__msg__TravelerConfig(
  const traveler_msgs__msg__TravelerConfig * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traveler_msgs
bool cdr_deserialize_traveler_msgs__msg__TravelerConfig(
  eprosima::fastcdr::Cdr & cdr,
  traveler_msgs__msg__TravelerConfig * ros_message)
{
  // Field name: running_scenario
  {
    std::string tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = traveler_msgs__msg__TravelerConfig;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traveler_msgs
bool cdr_serialize_key_traveler_msgs__msg__TravelerConfig(
  const traveler_msgs__msg__TravelerConfig * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: running_scenario
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traveler_msgs
size_t get_serialized_size_key_traveler_msgs__msg__TravelerConfig(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TravelerConfig__ros_msg_type * ros_message = static_cast<const _TravelerConfig__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_traveler_msgs
size_t max_serialized_size_key_traveler_msgs__msg__TravelerConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const traveler_msgs__msg__TravelerConfig * ros_message = static_cast<const traveler_msgs__msg__TravelerConfig *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_traveler_msgs__msg__TravelerConfig(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  traveler_msgs__msg__TravelerConfig * ros_message = static_cast<traveler_msgs__msg__TravelerConfig *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_traveler_msgs__msg__TravelerConfig(cdr, ros_message);
}
...
static size_t _TravelerConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_traveler_msgs__msg__TravelerConfig(
