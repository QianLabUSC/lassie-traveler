...
#ifndef TRAVELER_MSGS__MSG__DETAIL__TRAVELER_CONFIG__TYPE_SUPPORT_H_
#define TRAVELER_MSGS__MSG__DETAIL__TRAVELER_CONFIG__TYPE_SUPPORT_H_
...
#endif  // TRAVELER_MSGS__MSG__DETAIL__TRAVELER_CONFIG__TYPE_SUPPORT_H_
