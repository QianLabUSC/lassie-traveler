...
traveler_msgs__msg__TravelerMode__create(void)
{
  ...
  traveler_msgs__msg__TravelerMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    traveler_msgs__msg__TravelerMode * data =
      (traveler_msgs__msg__TravelerMode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!traveler_msgs__msg__TravelerMode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          traveler_msgs__msg__TravelerMode__fini(&output->data[i]);
        }
        return false;
      }
    }
